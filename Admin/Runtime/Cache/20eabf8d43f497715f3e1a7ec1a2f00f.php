...
<body>
	...
	<div id='left'>
		...
		<ul class='option'>
			...
			<li><a href='<?php echo U("User/searchUser");?>'>检索用户</a></li>
		...
		<ul class='option'>
			<li><a href='<?php echo U("Weibo/index");?>'>原创微博</a></li>
			<li><a href='<?php echo U("Weibo/turn");?>'>转发微博</a></li>
			<li><a href='<?php echo U("Weibo/searchWeibo");?>'>检索微博</a></li>
		</ul>
		<div class='nav'>
		...
		<ul class='option'>
			...
			<li><a href='<?php echo U("Weibo/searchComment");?>'>评论检索</a></li>
		</ul>
		<div class='nav'>
