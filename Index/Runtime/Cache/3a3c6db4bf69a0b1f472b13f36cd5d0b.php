...
<head>
	...
	<title><?php echo (C("WEBNAME")); ?>-空间</title>
	<link rel="stylesheet" href="__PUBLIC__/Theme/<?php echo ($style); ?>/Css/nav.css" />
	<link rel="stylesheet" href="__PUBLIC__/Theme/<?php echo ($style); ?>/Css/user.css" />
    ...
    <script type='text/javascript'>
        ...
        var delWeiboUrl = '<?php echo U("Index/delWeibo");?>';
    </script>
    <!--==========顶部固定导行条==========-->
    <script type="text/javascript">
...
<script type='text/javascript'>
	...
	<div id='userinfo'>
		<div class='info-list'>
			<div class='info-face'>
				...
				<ul>
					<li>
						<a href="<?php echo U('follow/'.$userinfo['user_id']);?>"><strong><?php echo ($userinfo["follow"]); ?></strong><br/>关注</a>
					</li>
					<li>
						<a href="<?php echo U('fans/'.$userinfo['user_id']);?>"><strong><?php echo ($userinfo["fans"]); ?></strong><br/>粉丝</a>
					</li>
					<li>
						<a href="<?php echo U('/' . $userinfo['user_id']);?>"><strong><?php echo ($userinfo["weibo"]); ?></strong><br/>微博</a>
					</li>
				</ul>
			</div>
			<ul class='uinfo'>
            ...
            <?php if(isset($_SESSION["user_id"]) && $_SESSION["user_id"] == $_GET["user_id"]): ?><li class='uedit full'>
					<a href="<?php echo U('Account/index');?>">修改个人资料</a>
				</li><?php endif; ?>
			</ul>
		</div>
	</div>
    <div class="main">
        ...
        <!--微博发布框-->
    <?php if(isset($_SESSION["user_id"]) && $_SESSION["user_id"] == $_GET["user_id"]): ?><div class='send_wrap'>
...
<?php if(is_array($weibo)): foreach($weibo as $key=>$v): if(!$v["isturn"]): ?><!--=====普通微博样式=====-->
        <div class="weibo">
            <div class="wb_cons">
                <dl>
                    <!--用户名-->
                    <dt class='author hidden'><a href="<?php echo U('/' . $v['user_id']);?>"><?php echo ($v["username"]); ?></a>
                    </dt>
                    <!--发布内容-->
                    <dd class='content'>
                ...
                <?php if($v['max']): ?><dd>
                        <div class='wb_img'>
                            ...
                            <div class="img_tool hidden">
                                ...
                                <!--中图-->
                                <div class="img_info"><img src="__ROOT__/Uploads/Picture/<?php echo ($v["medium"]); ?>"/></div>
                            </div>
                        </div>
                    </dd><?php endif; ?>
                </dl>
                ...
                <div class="wb_tool">
                    ...
                    <ul>
                    <?php if(isset($_SESSION["user_id"]) && $_SESSION["user_id"] == $v["user_id"]): ?><li class='del-li hidden'><span class='del-weibo' weibo_id='<?php echo ($v["id"]); ?>'>删除</span></li>
                        ...
                        <li>|</li>
                        <li><span class='comment' weibo_id='<?php echo ($v["id"]); ?>'>评论<?php if($v["comment"]): ?>(<?php echo ($v["comment"]); ?>)<?php endif; ?></span></li>
                    </ul>
                </div>
                <!--=====回复框=====-->
        ...
        <div class="weibo">
            <div class="wb_cons">
                    ...
                    <dd>
                        <div class="wb_turn">
                            <dl>
                                <!--原作者-->
                                <dt class='turn_name'>
                                    <a href="<?php echo U('/' . $v['isturn']['user_id']);?>">@<?php echo ($v["isturn"]["username"]); ?></a>
                                </dt>
                                <!--原微博内容-->
                                <dd class='turn_cons'>
                                    <p><?php echo (replace_content($v["isturn"]["content"])); ?></p>
                                </dd>
                                <!--原微博图片-->
                ...
                <div class="wb_tool">
                    ...
                    <?php if(isset($_SESSION["user_id"]) && $_SESSION["user_id"] == $v["user_id"]): ?><li class='del-li hidden'><span class='del-weibo' weibo_id='<?php echo ($v["id"]); ?>'>删除</span></li>
                        <li class='del-li hidden'>|</li><?php endif; ?>
                        <li><span class='turn' weibo_id='<?php echo ($v["id"]); ?>' turn_id='<?php echo ($v["isturn"]["id"]); ?>'>转发<?php if($v["turn"]): ?>(<?php echo ($v["turn"]); ?>)<?php endif; ?></span></li>
                        <li>|</li>
                        <li class='keep-wrap'>
                            <span class='keep' weibo_id='<?php echo ($v["id"]); ?>'>收藏<?php if($v["keep"]): ?>(<?php echo ($v["keep"]); ?>)<?php endif; ?></span>
                            <div class='keep-up hidden'></div>
    ...
    <!--=====转发样式结束=====--><?php endif; endforeach; endif; endif; ?>
        ...
        <div id='right'>
        	<dl>
        		<dt>我的关注(<?php echo ($userinfo["follow"]); ?>) <?php if(count($follow) > 8): ?><a href="">更多»</a><?php endif; ?></dt>
