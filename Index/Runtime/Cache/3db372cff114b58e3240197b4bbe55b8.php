...
<head>
	...
	<link rel="stylesheet" href="__PUBLIC__/Theme/<?php echo ($style); ?>/Css/comment.css" />
    ...
    var delCommentUrl = "<?php echo U('delComment');?>";
    </script>
    <!--==========顶部固定导行条==========-->
    <script type="text/javascript">
    ...
    <div class="main">
        ...
        <?php if(is_array($comment)): foreach($comment as $key=>$v): ?><dl>
				...
				<dd>
					...
					<span><?php echo (replace_content($v["content"])); ?>（<?php echo (time_format($v["time"])); ?>）</span>
				</dd>
				<dd class='tright'>
					<span class='del-comment' comment_id='<?php echo ($v["id"]); ?>' weibo_id='<?php echo ($v["weibo_id"]); ?>'>删除</span> &nbsp;|&nbsp;
                ...
                <dd class='comment_list hidden'>
                    ...
                    <ul>
                        ...
                        <li class='comment_btn fright' weibo_id='<?php echo ($v["weibo_id"]); ?>'>回复</li>
                    </ul>
                </dd>
                <!--=====回复框结束=====-->
			</dl><?php endforeach; endif; ?>
            <div style="font-size: 18px;width: 100%;height: 50px;line-height: 50px;text-align: center;"><?php echo ($page); ?></div>
        </div>
        <!--==========右侧==========-->
        <div id="right">
